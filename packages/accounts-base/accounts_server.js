...
//
Ap._attemptLogin = function (methodInvocation,
                             methodName,
                             methodArgs,
                             result) {
    if (!result)
...
//
Ap._loginMethod = function (methodInvocation,
                            methodName,
                            methodArgs,
                            type,
                            fn) {
...
Ap._reportLoginFailure = function (methodInvocation,
                                   methodName,
                                   methodArgs,
                                   result) {
    var attempt = {
...
//        of the "login" method.
//
Ap.updateOrCreateUserFromExternalService = function (serviceName,
                                                     serviceData,
                                                     options) {
...
Ap._deleteSavedTokensForAllUsersOnStartup = function () {
    ...
    this.dbClient.deleteAllResumeTokens(null);
